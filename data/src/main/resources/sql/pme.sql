...
ALTER TABLE company add constraint `foreign_fk_1` foreign key (`ville_id`) REFERENCES `villes`(`id`);
...
;CREATE UNIQUE INDEX idx_technologies_pk
 ON pme.technologies
( 
  id
)
...
CREATE TABLE pme.project_technologies
(
  id BIGINT AUTO_INCREMENT NOT NULL PRIMARY KEY
, technology_id BIGINT
, project_id BIGINT
)
;CREATE UNIQUE INDEX idx_project_technologies_pk
